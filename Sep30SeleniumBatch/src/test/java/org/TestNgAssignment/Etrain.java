...
public class Etrain extends SeleniumUtil {
	...
	public void testetrain2() throws InterruptedException {
		...
		List<WebElement> trainNo = driver
				.findElements(By.xpath("//a[@title='Click on train number to View fare and schedule']"));
		...
		for (int i = 0; i < trainNo.size(); i++) {
			...
			System.out.println(trainNum.getText() + " " + trainNameList1.getText() + " " + deptTiming.getText() + " "
					+ travelTiming.getText());
